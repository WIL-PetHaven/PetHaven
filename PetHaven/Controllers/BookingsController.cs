...
namespace PetHaven.Controllers
{
    ...
    public class BookingsController : Controller
    {
        ...
        static async Task Execute(Bookings model)
        {
            ...
            var htmlContent1 = "<!DOCTYPE html> <html lang=\"en\"><head><meta charset=\"UTF-8\"> <meta name=\"viewport\" contentwidth=\"device-width\", initial-scale=\"1.0\", maximum-scale=\"1.0\", user-scalable=\"no\", height=\"device-height\"/> <meta http-equiv=\"X-UA-Compatible\" content=\"ie-edge\"/> </head> <body style=\"width: 100%;margin: 0px;padding: 0px;font-family: Arial, Helvetica, sans-serif;margin-top: 5vh;\"> <div class=\"container\" style=\"max-width: 800px;margin:auto;box-shadow: 0 6px 20px rgba(0,0,0,.4);height: auto;background-color: grey;\"> <div class=\"headingRow\" style=\"background-color: #39393A;width: 100%;padding: 15px 0;color: #ffff;display: grid;grid-template-columns: repeat(3, 1fr);\"> <div class=\"company\" style=\"text-align: left;font-size: 14px;padding-left: 20px;\"> </div> <div class=\"emailType\" style=\"text-align: center;\"> <h1 style =\"font-size: 20px;margin: 0;padding: 0;\">" +
                ...
                "</h1> </div> </div> <div class=\"emailContent\" style=\"padding: 5px 20px;background-color: #39393a;text-align: center;\">  <div class=\"customerInfo\" style=\"background-color: #F6F9FC;padding: 20px 20px;margin: 20px 0;\"> <p class=\"emailContent_title\" style=\"font-size: 20px;margin-bottom: 20px;\"> <b>" +
                "Booking Information" +
                ...
                "</p> </div> <div class=\"custRow\" style=\"margin-bottom: 10px;display: grid;grid-template-columns: .5fr 1fr;grid-column-gap: 20px;\"> <p class=\"cust-item\" style=\"text-align: left;padding: 5px 0;\">Address:</p> <a href=\"https://www.google.com/maps/place/1+William+Leister+Dr,+Westville,+Durban,+3613/\"><img src=\"https://maps.googleapis.com/maps/api/staticmap?center=1+William+Leister+Dr,+Westville,+Durban,+3613&zoom=15&scale=1&size=600x300&maptype=roadmap&key=AIzaSyAsw4AWtI4dgvQ492sC1eCzetzfzs4UHUo&format=png&visual_refresh=true&markers=size:mid%7Ccolor:0xff0000%7Clabel:1%7C1+William+Leister+Dr,+Westville,+Durban,+3613\" alt=\"Google Map of 1 William Leister Dr, Westville, Durban, 3613\"></a> </div> </div> </div> </div> </div> </body> </html>";
