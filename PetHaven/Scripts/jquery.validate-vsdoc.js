 ...
 * terms; or (ii) using the files as included with a Microsoft Animal subject
 * to that Animal's license terms. Microsoft reserves all other rights to the
...
* standard jQuery library for all Animalion use.
*
